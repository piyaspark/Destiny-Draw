            ...
            if (round == -1) {
                ...
                switch (round) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        player6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + playerCard[4] + ".png")));
                        round++;
                        ...
                        break;
                    case 4:
                        player7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + playerCard[4] + ".png")));
                        round++;
                        ...
                        break;
                    case 5:
                        player8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + playerCard[4] + ".png")));
                        round++;
            ...
            if (round == -1) {
                ...
                switch (count) {
                    ...
                    case 4:
                        ...
                        dealer4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[3] + ".png")));
                        dealer5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[4] + ".png")));
                        dealer6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[4] + ".png")));
                        DealerScore.setText(String.valueOf(dealerScore));
                        checkWinORLose(playerScore, dealerScore);
                        reset();
                        break;
                    case 5:
                        ...
                        dealer5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[4] + ".png")));
                        dealer6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[4] + ".png")));
                        dealer7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[4] + ".png")));
                        DealerScore.setText(String.valueOf(dealerScore));
                        checkWinORLose(playerScore, dealerScore);
                        reset();
                        break;         
                    case 6:
                        ...
                        dealer6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[4] + ".png")));
                        dealer7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[4] + ".png")));
                        dealer8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DeckOfCard/" + dealerCard[4] + ".png")));
                        DealerScore.setText(String.valueOf(dealerScore));
                        checkWinORLose(playerScore, dealerScore);
                        reset();
                        break;                    default:
